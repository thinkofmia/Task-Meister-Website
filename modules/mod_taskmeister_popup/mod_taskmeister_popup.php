...
$displayHeader = ModPopupHelper::getHeader($params);//Set variable of inputtable header
$displayText = ModPopupHelper::getText($params);//Set variable of inputtable text
require JModuleHelper::getLayoutPath('mod_taskmeister_popup');//Opens up default.php