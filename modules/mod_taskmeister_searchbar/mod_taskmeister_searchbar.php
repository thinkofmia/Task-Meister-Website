...
$displayHeader = ModSearchBarHelper::getHeader($params);//Set variable of inputtable header
$displayText = ModSearchBarHelper::getText($params);//Set variable of inputtable text
require JModuleHelper::getLayoutPath('mod_taskmeister_searchbar');//Opens up default.php