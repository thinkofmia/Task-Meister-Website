...
$inputAttributes = array(
	'type' => 'text', 'id' => $id, 'value' => $this->escape($userName), 'placeholder' => 'Username'
);
...
$anchorAttributes = array(
	'placeholder' => 'Username', 'class' => 'btn btn-primary modal_' . $id, 'title' => JText::_('JLIB_FORM_CHANGE_USER'), 'rel' => '{handler: \'iframe\', size: {x: 800, y: 500}}'
);
