...
//20151023: Tina Tan: Add facebook/twitter meta code from http://forum.joomla.org/viewtopic.php?f=712&t=786152  
if (isset($images->image_intro) and !empty($images->image_intro))
{	
    if(filter_var($images->image_intro, FILTER_VALIDATE_URL) === FALSE)
    {
       $timage= htmlspecialchars(JURI::root().$images->image_intro);
    }
    else
    {
	    $timage= htmlspecialchars($images->image_intro);
    }
}
elseif (isset($images->image_fulltext) and !empty($images->image_fulltext))
{
    if(filter_var($images->image_fulltext, FILTER_VALIDATE_URL) === FALSE)
    {
	    $timage= htmlspecialchars(JURI::root().$images->image_fulltext);
    }
    else
    {
	    $timage= htmlspecialchars($images->image_fulltext);
    }
}
else
{
...
/* removed from above code because already defined in plugin:socialbuttons 
$config->get('mailfrom')
   <meta property="og:url" content="'.JURI::current().'"/>*/
