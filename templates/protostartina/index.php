...
//$doc->addScript($this->baseurl . '/templates/' . $this->template . '/js/slick.min.js');


// Add Stylesheets
$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/template.css');
$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/keen-slider.min.css');
	...
	<footer class="footer" role="contentinfo">
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
			...
			<p>
				...
				Contents are licensed <a href="https://creativecommons.org/licenses/by-sa/3.0/sg/">Creative Commons Attribution-Share Alike 3.0 Singapore License</a> . Separately, for commercial use of EasyJavaScriptSimulations Library, please read <a href="http://www.um.es/fem/EjsWiki/Main/EJSLicense/">http://www.um.es/fem/EjsWiki/Main/EJSLicense</a>  and contact fem@um.es directly. <?php echo date('Y'); ?> <?php echo $sitename; ?>
			</p>
		</div>
	</footer>
